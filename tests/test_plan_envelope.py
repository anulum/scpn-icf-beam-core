...
# SCPN ICF Beam Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "89745c95ccd77dedb16f313a1c0fa481b914d4293941074eb53a8d05447c19f2"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-ICF-BEAM-CORE"
    assert NON_CLAIMS == (
