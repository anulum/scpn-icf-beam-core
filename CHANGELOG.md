...
- Generated repository header artwork: `docs/assets/generate_header.py`
  ...
  domain surface (the two-sided accelerator drive used by the README,
  the species split, and the heavy-ion energy window).
...
- Diagnostic and clock semantics model
  (`src/scpn_icf_beam_core/observability.py`), the second implemented
...
- Device configuration model (`src/scpn_icf_beam_core/`), the first implemented
